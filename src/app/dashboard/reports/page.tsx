                      ...
                      <div className="grid gap-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm">{check.temperature}°C</span>
                          </div>
                          <div className="flex items-center gap-2">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div className="flex items-center gap-2">
                            <Check className={`h-4 w-4 ${check.is_clean ? 'text-green-500' : 'text-red-500'}`} />
                            <span className="text-sm">
                              {check.is_clean ? 'Bersih' : 'Perlu Dibersihkan'}
                            </span>
                          </div>
                          <div className="flex items-center gap-2">
                            <Shield className={`h-4 w-4 ${check.is_secure ? 'text-green-500' : 'text-red-500'}`} />
                            <span className="text-sm">
                        ...
                        <div>
                          ...
                          <p className={`text-sm ${
                            check.equipment_status === 'Normal' ? 'text-green-600' :
                            check.equipment_status === 'Perlu Pengecekan' ? 'text-yellow-600' :
                            'text-red-600'
                          }`}>
