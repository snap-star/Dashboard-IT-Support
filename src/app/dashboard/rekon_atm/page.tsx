...
export default function ATMReconciliationPage() {
  ...
  const exportToExcel = () => {
    ...
    const summaryData = [
      ...
      ['50.000', summary.d50k.in, summary.d50k.out, summary.d50k.in - summary.d50k.out],
      ['100.000', summary.d100k.in, summary.d100k.out, summary.d100k.in - summary.d100k.out],
      ['Total', summary.total.in, summary.total.out, summary.total.in - summary.total.out]
    ];
                    ...
                    >
                      ...
                      <SelectContent className="max-h-[300px]">
                        {atms && atms.length > 0 ? (
                            ...
                            >
                              <div className="flex items-center justify-between w-full">
                                <div className="flex flex-col">
                                  ...
                                  <span className="text-sm text-muted-foreground">{atm.location}</span>
                                </div>
                                <span className={`px-2.5 py-0.5 rounded-full text-xs font-medium ${getTypeColor(atm.type)}`}>
                                  {atm.type}
                                </span>
                              </div>
                            </SelectItem>
                          ...
                          <SelectItem value="no-data" className="text-center py-2 text-muted-foreground">
                            Tidak ada data ATM
                          </SelectItem>
                        )}
                      </SelectContent>
          ...
          <CardContent>
            <div className="grid gap-4">
              ...
              <div className="grid grid-cols-4 gap-4 p-3 border rounded-lg">
                ...
                <div className={`font-medium ${summary.d50k.in - summary.d50k.out === 0 ? 'text-green-600' : 'text-red-600'}`}>
              ...
              <div className="grid grid-cols-4 gap-4 p-3 border rounded-lg">
                ...
                <div className={`font-medium ${summary.d100k.in - summary.d100k.out === 0 ? 'text-green-600' : 'text-red-600'}`}>
                  {(summary.d100k.in - summary.d100k.out).toLocaleString('id-ID')}
                </div>
              </div>
              <div className="grid grid-cols-4 gap-4 font-medium p-3 bg-muted rounded-lg mt-2">
                ...
                <div className={summary.total.in - summary.total.out === 0 ? 'text-green-600' : 'text-red-600'}>
                  {(summary.total.in - summary.total.out).toLocaleString('id-ID')}
                </div>
              </div>
            </div>
          </CardContent>
