    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Upload file EJ untuk memeriksa selisih keuangan ATM</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="flex gap-4">
                ...
                {summary && (
                  <Button type="button" onClick={exportToExcel} className="w-full sm:w-auto">
          ...
          <CardContent>
            <div className="grid gap-4">
              ...
              <div className="grid grid-cols-4 gap-4 p-3 border rounded-lg">
                ...
                <div
                  className={`font-medium ${
                    summary.d50k.in - summary.d50k.out === 0 ? 'text-green-600' : 'text-red-600'
                  }`}
                >
              ...
              <div className="grid grid-cols-4 gap-4 p-3 border rounded-lg">
                ...
                <div
                  className={`font-medium ${
                    summary.d100k.in - summary.d100k.out === 0 ? 'text-green-600' : 'text-red-600'
                  }`}
                >
              ...
              <div className="grid grid-cols-4 gap-4 font-medium p-3 bg-muted rounded-lg mt-2">
                ...
                <div
                  className={
                    summary.total.in - summary.total.out === 0 ? 'text-green-600' : 'text-red-600'
                  }
                >
