...
export default function Home() {
  ...
  return (
    ...
    <div id="header-form-pengajuan" className="p-8 max-w-4xl mx-auto">
      ...
      <Table className="border border-gray-950 bg-white">
        <TableHeader>
          <TableRow>
            <TableCell className="border px-4 py-2 w-1/3 text-center font-bold text-sm">GROUP IT SUPPORT & HELPDESK</TableCell>
          ...
          <TableRow>
            <TableCell className="border px-4 py-2 text-left text-xs">Nomor Registrasi:</TableCell>
          </TableRow>
          <TableRow>
          ...
          <TableRow>
            ...
            <TableCell className="border px-4 py-2 text-center font-bold bg-red-700 text-white">DOKUMEN 4.3.2</TableCell>
          </TableRow>
        </TableHeader>
        <TableBody>
      ...
      {/* Form */}
      <form id="form-pengajuan" ref={formRef} onSubmit={handleSubmit(onSubmit)} className="space-y-6 bg-white">
  ...
  <Table className="w-full border text-center items-center font-normal">
    ...
    <TableHeader>
      <TableRow>
        <TableCell colSpan={2} className="border px-1 py-1 text-center bg-red-700 font-bold text-white text-sm">
          Diperiksa Oleh
        </TableCell>
        <TableCell className="border px-1 py-1 text-center bg-red-700 font-bold text-white text-sm">Disetujui Oleh</TableCell>
        <TableCell className="border px-1 py-1 text-center bg-red-700 font-bold text-white text-sm">Dibuat Oleh</TableCell>
      </TableRow>
    </TableHeader>
    <TableBody>
      <TableRow>
  ...
  <Table className="border border-gray-300 w-full">
    ...
    <TableBody>
      ...
      <TableRow>
        <TableCell className="border px-4 py-2 text-center font-bold text-xs">Pjs. VP Teknologi Informasi</TableCell>
        <TableCell className="border px-4 py-2 text-center font-bold text-xs">AVP Infrastruktur TI & Operasi</TableCell>
      </TableRow>
      <TableRow>
      ...
      <Button className="hover:bg-yellow-400 hover:text-dark print:hidden" variant="outline" type="button" onClick={() => append({ appName: "", user: "", startDate: "", endDate: "", reason: "", risk: "" })}>
            Tambah Aplikasi
          </Button>
          <Button variant="outline" type="button" onClick={() => remove()} className="hover:bg-red-600 hover:text-white print:hidden">Hapus</Button>
