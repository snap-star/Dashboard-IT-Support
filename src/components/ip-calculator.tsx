      ...
      <CardContent className="space-y-4">
        ...
        {result.networkAddress && (
          <div className="mt-4 space-y-2">
            ...
            <p><strong>First Usable Address:</strong> {result.firstUsableAddress}</p>
            <p><strong>Last Usable Address:</strong> {result.lastUsableAddress}</p>
            <p><strong>Total Host:</strong> {result.totalHosts}</p>
          </div>
        )}
      </CardContent>
    </Card>
